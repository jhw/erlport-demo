#!/usr/bin/env python
"""Test Fishy scraper with fixture data"""
...
class TestFishyScraper(unittest.TestCase):
    """Test Fishy scraper functionality"""

    def setUp(self):
        """Load fixture data"""
        self.fixture_path = os.path.join(script_dir, 'fixtures', 'fishy_eng1.html')
    ...
    def test_known_matches(self):
        ...
        self.assertTrue(
            any('Man City vs Liverpool (3-0)' in s for s in result_strings),
    ...
    def test_removes_duplicates(self):
        ...
        # Should have same number as results (no duplicates)
    ...
    def test_results_sorted(self):
        ...
        self.assertEqual(dates, sorted(dates), "Results not sorted by date")
